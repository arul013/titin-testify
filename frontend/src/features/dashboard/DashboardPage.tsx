      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div>
          <Badge
            ...
            className="px-4 py-1.5 text-xs font-bold uppercase tracking-wider shadow-xs"
          >
            {user.role.replace("_", " ")}
          </Badge>
        </div>
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          <Card>
            ...
            <div className="p-5 rounded-2xl bg-slate-50/50 border border-slate-200/50 flex gap-4">
              <div className="w-2.5 h-2.5 rounded-full bg-indigo-600 mt-2 shrink-0 animate-pulse" />
              <div>
                <h4 className="text-sm font-bold text-gray-900">
                  Selamat Datang di CBT Titin Testify
                </h4>
                <p className="text-sm text-gray-600 mt-1.5 leading-relaxed">
                  Ujian simulasi akan dijadwalkan oleh admin. Pastikan Anda
                  memiliki aplikasi Safe Exam Browser (SEB) terinstal untuk
                  pengerjaan ujian mendatang.
                </p>
